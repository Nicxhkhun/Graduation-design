...
/* window.onload=function(){
	...
	function formSubmit() {
	    ...
	    var url = "<%=request.getContextPath() %>/roomtype/add.do";
	    $.ajax({
			type: 'post',
			url: url,
...
<body style="overflow-x:hidden;"> 
	<form class="form-horizontal" role="form" method="post" id="tform"> 
		<div class="top_title"><strong>客房类型</strong></div>
			<input type="hidden" name="id" value="${learner.id}"> 
		<div style="margin-left:100px">
			<div class="form-group">
		      <label for="lastname" class="clo_sex">类型名称</label>
		      	<div style="width:200px;display: inline-block;">
		         	<input type="text" class="form-control" id="tp_name"  placeholder="请输入类型名称" name="tp_name" value="" onblur="checkName()">
		    	</div>	
		...
		<div class="form-group">
		    ...
		    <div style="width:200px;display: inline-block;" >
		        	<input type="text" class="form-control" name="price" id="price" placeholder="请输入价格" onblur="checkPrice()" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')">
			</div>
